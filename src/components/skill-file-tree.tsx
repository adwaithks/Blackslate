...
type Node = {
	name: string
	fullPath: string | null // null = directory
	children: Map<string, Node>
}

function buildTree(files: string[], rootDir: string): Node {
	const root: Node = { name: "", fullPath: null, children: new Map() }
...
// ---------------------------------------------------------------------------
// Tree node — folder (collapsible) or file (selectable button)
// ---------------------------------------------------------------------------
...
/**
 * Renders a collapsible file tree for a skill bundle.
 *
 * @param files    Flat list of absolute file paths inside the skill.
 * @param rootDir  Absolute path of the skill root directory (used to derive
 *                 relative display names). Files not under rootDir fall back
 *                 to showing just their basename.
 */
export function SkillFileTree({
	...
	const root = buildTree(files, rootDir)
	return (
