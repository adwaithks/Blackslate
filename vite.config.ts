...
export default defineConfig(({ command }) => ({
	...
	// Strip console.* calls and debugger from production bundles (tauri build / vite build).
	// References like `.catch(console.error)` are kept; only direct calls are removed.
	esbuild: {
